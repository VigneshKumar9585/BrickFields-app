...
export default function EnquiryFullDetails() {
    const { id } = useParams();
    ...
    const enquiryDetails = [
        ...
        { label: "Preferred Time", value: formatTime(enquiry.preferTime) },
    ...
    const tech1 = enquiry.assignedTechnician1 ? [
        ...
        { label: "State", value: enquiry.assignedTechnician1.state },
        { label: "District", value: enquiry.assignedTechnician1.district },
        { label: "Region", value: enquiry.assignedTechnician1.region },
    ] : null;
    ...
    const tech2 = enquiry.assignedTechnician2 ? [
        ...
        { label: "State", value: enquiry.assignedTechnician2.state },
        { label: "District", value: enquiry.assignedTechnician2.district },
        { label: "Region", value: enquiry.assignedTechnician2.region },
    ] : null;
