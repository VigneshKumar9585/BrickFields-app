              ...
              >
                ...
                <Box mb={3}>
                  ...
                  <Box display="flex" gap={2} flexWrap="wrap">
                    <Button
                      disabled={!selectedTask?.instagramLink}
                      variant="outlined"
                      startIcon={<Instagram size={16} />}
                      onClick={() => selectedTask?.instagramLink && window.open(selectedTask?.instagramLink, "_blank")}
                      sx={{
                        textTransform: "none",
                        borderColor: "#e2e8f0",
                        color: selectedTask?.instagramLink ? "#E1306C" : "#94a3b8",
                        fontWeight: 600,
                        borderRadius: "8px",
                        px: 2,
                        "&:hover": { borderColor: "#E1306C", bgcolor: "rgba(225, 48, 108, 0.05)" }
                      }}
                    >
                      Instagram
                    </Button>
                    ...
                    <Button
                      disabled={!selectedTask?.linkedinLink}
                      variant="outlined"
                      startIcon={<Linkedin size={16} />}
                      onClick={() => selectedTask?.linkedinLink && window.open(selectedTask?.linkedinLink, "_blank")}
                      sx={{
                        textTransform: "none",
                        borderColor: "#e2e8f0",
                        color: selectedTask?.linkedinLink ? "#0077B5" : "#94a3b8",
                        fontWeight: 600,
                        borderRadius: "8px",
                        px: 2,
                        "&:hover": { borderColor: "#0077B5", bgcolor: "rgba(0, 119, 181, 0.05)" }
                      }}
                    >
                      LinkedIn
                    </Button>
                    ...
                    <Button
                      disabled={!selectedTask?.youtubeLink}
                      variant="outlined"
                      startIcon={<Youtube size={16} />}
                      onClick={() => selectedTask?.youtubeLink && window.open(selectedTask?.youtubeLink, "_blank")}
                      sx={{
                        textTransform: "none",
                        borderColor: "#e2e8f0",
                        color: selectedTask?.youtubeLink ? "#FF0000" : "#94a3b8",
                        fontWeight: 600,
                        borderRadius: "8px",
                        px: 2,
                        "&:hover": { borderColor: "#FF0000", bgcolor: "rgba(255, 0, 0, 0.05)" }
                      }}
                    >
                      Youtube
                    </Button>
