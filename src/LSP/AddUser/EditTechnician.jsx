...
function editTechnician() {
    ...
    console.log("Editing technician ID:", existingDocs);
    ...
    const validate = () => {
        ...
        // if (formValues.password && formValues.password.length < 6) temp.passwo rd = "Password must be at least 6 characters";
    ...
    const handleSubmit = async () => {
        ...
        try {
            await axios.put(`${BACKEND_URL}/api/update-technician/${id}`, formData, {
                    ...
                    {viewImages.length === 0 ? (
                        ...
                        >
                            {viewImages.map((imgName, i) => {
                                const fullUrl = `${BACKEND_URL}/upload-technician-images/${imgName}`;
                                return (
                                    <Box
                                        key={i}
                                        sx={{
