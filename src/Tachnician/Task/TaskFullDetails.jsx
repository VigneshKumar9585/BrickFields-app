...
function TaskFullDetails() {
    ...
    const lspDetails = enquiry.assignedLSP ? [
        ...
        { label: "City", value: enquiry.assignedLSP.city },

        { label: "State", value: enquiry.assignedLSP.state },
        { label: "District", value: enquiry.assignedLSP.district },
        { label: "Region", value: enquiry.assignedLSP.serviceArea || enquiry.assignedLSP.city },


        // { label: "Role", value: "LSP" },
    ] : null;
    ...
    const tech1 = enquiry.assignedTechnician1 ? [
        ...
        { label: "Email", value: enquiry.assignedTechnician1.email },
        { label: "City", value: enquiry.assignedTechnician1.city },
        { label: "State", value: enquiry.assignedTechnician1.state || enquiry.assignedTechnician1.mobile },
        { label: "District", value: enquiry.assignedTechnician1.district || enquiry.assignedTechnician1.mobile },
        { label: "Region", value: enquiry.assignedTechnician1.region || enquiry.assignedTechnician1.mobile },
    ...
    const tech2 = enquiry.assignedTechnician2 ? [
        ...
        { label: "Email", value: enquiry.assignedTechnician2.email },
        { label: "City", value: enquiry.assignedTechnician2.city },
        { label: "State", value: enquiry.assignedTechnician2.state || enquiry.assignedTechnician2.mobile },
        { label: "District", value: enquiry.assignedTechnician2.district || enquiry.assignedTechnician2.mobile },
        { label: "Region", value: enquiry.assignedTechnician2.region || enquiry.assignedTechnician2.mobile },
    ] : null;
