...
const SidebarLayout = () => {
  ...
  useEffect(() => {
    ...
    if (location.pathname.startsWith("/master/")) {
      setOpenKeys((prev) => ({ ...prev, Master: true }));
    }
  }, [location.pathname]);
      ...
      <List>
        ...
        <ListItemButton
          ...
          sx={{
            ...
            backgroundColor:
              openKeys.Enquiry ||
              isSubmenuActive(["/admin-new-enquiry", "/admin-manage-enquiry"])
                ? "#e0f7fa"
                : "transparent",
            fontWeight:
              openKeys.Enquiry ||
